...
VL_ATTR_COLD void Vtop___024root___initial__TOP__0(Vtop___024root* vlSelf) {
    ...
    VL_READMEM_N(true, 8, 4096, 3217031168, std::string{"f1.mem"}
                 ...
                 , 3217031168, ~0ULL);
    vlSelf->top__DOT__Memory_Stage__DOT__memory__DOT__cache__DOT__V[0U] = 0U;
    vlSelf->top__DOT__Memory_Stage__DOT__memory__DOT__cache__DOT__V[1U] = 0U;
    vlSelf->top__DOT__Memory_Stage__DOT__memory__DOT__cache__DOT__V[2U] = 0U;
    vlSelf->top__DOT__Memory_Stage__DOT__memory__DOT__cache__DOT__V[3U] = 0U;
    vlSelf->top__DOT__Memory_Stage__DOT__memory__DOT__cache__DOT__V[4U] = 0U;
    vlSelf->top__DOT__Memory_Stage__DOT__memory__DOT__cache__DOT__V[5U] = 0U;
    vlSelf->top__DOT__Memory_Stage__DOT__memory__DOT__cache__DOT__V[6U] = 0U;
    vlSelf->top__DOT__Memory_Stage__DOT__memory__DOT__cache__DOT__V[7U] = 0U;
    vlSelf->top__DOT__Memory_Stage__DOT__memory__DOT__cache__DOT__unnamedblk1__DOT__i = 8U;
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__Memory_Stage__DOT__memory__DOT__hit = VL_RAND_RESET_I(1);
    for (int __Vi0=0; __Vi0<131072; ++__Vi0) {
        vlSelf->top__DOT__Memory_Stage__DOT__memory__DOT__main_memory__DOT__DataMemory_array[__Vi0] = VL_RAND_RESET_I(8);
    }
    for (int __Vi0=0; __Vi0<8; ++__Vi0) {
        vlSelf->top__DOT__Memory_Stage__DOT__memory__DOT__cache__DOT__data[__Vi0] = VL_RAND_RESET_I(32);
    }
    for (int __Vi0=0; __Vi0<8; ++__Vi0) {
        vlSelf->top__DOT__Memory_Stage__DOT__memory__DOT__cache__DOT__tag[__Vi0] = VL_RAND_RESET_I(27);
    }
    for (int __Vi0=0; __Vi0<8; ++__Vi0) {
        vlSelf->top__DOT__Memory_Stage__DOT__memory__DOT__cache__DOT__V[__Vi0] = VL_RAND_RESET_I(1);
    }
    vlSelf->top__DOT__Memory_Stage__DOT__memory__DOT__cache__DOT__unnamedblk1__DOT__i = 0;
