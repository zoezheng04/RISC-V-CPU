...
class Vtop___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ top__DOT__Memory_Stage__DOT__memory__DOT__hit;
    ...
    struct {
        ...
        IData/*31:0*/ top__DOT__Memory_Stage__DOT__memory__DOT__cache__DOT__unnamedblk1__DOT__i;
        ...
        VlUnpacked<IData/*31:0*/, 8> top__DOT__Memory_Stage__DOT__memory__DOT__cache__DOT__data;
        VlUnpacked<IData/*26:0*/, 8> top__DOT__Memory_Stage__DOT__memory__DOT__cache__DOT__tag;
        VlUnpacked<CData/*0:0*/, 8> top__DOT__Memory_Stage__DOT__memory__DOT__cache__DOT__V;
